...
```
library(devtools)
install_github("rkward-community/rk.MultidimensionalScaling") # stable release
install_github("rkward-community/rk.MultidimensionalScaling", ref="develop") # development release
```
